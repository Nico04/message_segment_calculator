...
/// Importing a package to handle Unicode graphemes more efficiently.

/// Importing a package to handle Unicode graphemes more efficiently.

import '../message_segment_calculator.dart';

/// Import utility for message segment calculations.
/// Import utility for message segment calculations.
...
/// Import data structure for SMS segments.

enum SmsEncoding { gsm7, ucs2, auto }

/// Define supported SMS encodings.

enum LineBreakStyle { lf, crlf, lfCrlf, none }

/// Define types of line breaks.

class SegmentedMessage {
  SmsEncoding? encoding;

  /// The encoding used for the SMS.
  List<Segment> segments = [];

  /// List to store message segments.
  List<String> characters = [];

  /// List of characters in the message.
  SmsEncoding? encodingName;
  ...
  /// Count of characters in the message.
  List<EncodedChar> encodedChars = [];

  /// List of encoded characters.
  LineBreakStyle? lineBreakStyle;

  /// The style of line breaks used in the message.
